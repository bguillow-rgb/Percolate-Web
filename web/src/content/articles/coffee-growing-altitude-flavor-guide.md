---
title: "How Coffee Growing Altitude Shapes Flavor (MASL Guide)"
description: "Higher altitude means slower bean growth, denser beans, and more complex flavor. Learn how MASL numbers on your coffee bag predict what's in your cup."
tier: "detail"
targetQuery: "how does coffee growing altitude affect flavor"
relatedQueries:
  - "what does MASL mean on coffee bag"
  - "high altitude coffee flavor profile"
  - "SHG SHB coffee meaning"
  - "coffee elevation and taste"
...
faqs:
  ...
  - q: "What is considered high-altitude coffee?"
    a: "Most industry sources place high-altitude coffee at 1,200 meters (about 4,000 feet) above sea level and higher. Above 1,500 masl is consistently where the most interesting specialty lots grow; above 1,800 masl is exceptional territory."
  - q: "What do SHG and SHB mean on a coffee label?"
    a: "SHG (Strictly High Grown) and SHB (Strictly Hard Bean) are altitude-based grading terms used mainly in Central America. Both indicate coffee grown above approximately 1,200-1,350 meters. SHG is the term used in Mexico and some Central American countries; SHB is common in Guatemala and Honduras, they mean the same thing."
  - q: "Does higher altitude always mean better coffee?"
    a: "Altitude is a strong quality indicator but not an absolute guarantee. Farm management, processing method, and roaster skill all interact with elevation. Some exceptional low-altitude coffees, like Hawaiian Kona, achieve complexity through other environmental factors such as latitude, shade, or unusual soil."
  - q: "Does altitude affect caffeine content in coffee?"
    a: "Altitude primarily affects flavor and bean density, not caffeine levels in a meaningful way. Some studies show slightly lower caffeine at higher altitudes due to slower growth, but the taste and aroma differences are far more pronounced than any caffeine difference you'd notice in your cup."
  - q: "What brew method suits high-altitude coffee best?"
    a: "High-altitude beans shine in pour-over or filter methods, where their bright acidity and floral complexity can fully express themselves. Low-altitude beans, with their fuller body and chocolate notes, often excel in French press, cold brew, and milk-based espresso drinks."
published: true
---
...
| Altitude Band | Range (approx.) | Flavor Character | Typical Regions | Best Brew Methods |
|---|---|---|---|---|
| **Low** | Below 900 m | Mild, earthy, soft body, muted acidity | Brazil lowlands, some Indonesia | French press, cold brew, dark-roast espresso |
| **Mid** | 900-1,500 m | Balanced sweetness, gentle acidity, caramel, stone fruit | Colombia mid-range, Honduras, Peru | Drip, Moka pot, pour-over |
| **High** | 1,500-1,800 m | Bright acidity, chocolate, citrus, red apple | Colombia Nariño, Guatemala, Costa Rica | Pour-over, AeroPress |
| **Very High** | 1,800 m+ | Sparkling acidity, floral, jasmine, tropical fruit, tea-like | Ethiopia, Kenya, Yemen, Rwanda highlands | Light-roast pour-over, Chemex |
...
- **You want earthy, chocolate comfort**: Look for bags under 1,200 masl, Brazil, most Indonesian lots. These work beautifully in French press or as a base for milk drinks.
- **You want balance and sweetness**: Target the 1,200-1,600 masl window. Colombian, Honduran, and Peruvian coffees in this range often hit caramel, stone-fruit, and gentle cocoa notes that suit drip and pour-over equally well.
- **You want bright, fruit-forward, complex**: Go for 1,600 masl and above. If you love bright, citrus-driven coffees with aromatic intensity, high-altitude lots from Ethiopia, Kenya, or Colombia's highest mountains may be your ideal match.
...
For a deeper look at how grind size interacts with brew method, see our [coffee grind size guide](/coffee-grind-size-by-brew-method), the altitude of your bean is one more reason why dialing in per-bag matters more than using a single preset.
