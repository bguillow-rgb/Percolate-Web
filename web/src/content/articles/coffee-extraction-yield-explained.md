---
title: "Coffee Extraction Yield Explained: TDS, EY & Taste"
description: "Extraction yield is the % of coffee solubles in your cup. Learn what TDS and EY mean, the 18–22% target, and how to fix sour or bitter brews at home."
tier: "detail"
targetQuery: "what is coffee extraction yield"
relatedQueries:
  - "what is TDS in coffee"
  - "how to measure coffee extraction"
  - "coffee over extracted vs under extracted"
  - "SCA golden cup standard explained"
  - "how to fix sour or bitter coffee"
...
faqs:
  ...
  - q: "What is a good extraction yield for coffee?"
    a: "The Specialty Coffee Association's Golden Cup Standard defines the ideal extraction yield as 18-22% for filter coffee. That means 18-22% of the dry coffee grounds' mass has dissolved into your cup. Below 18% is generally under-extracted; above 22% risks over-extraction, though high-quality beans can taste great beyond this range."
  - q: "How do I calculate coffee extraction yield without a refractometer?"
    a: "Without a refractometer you can use taste as your primary guide: sour and thin means under-extracted, dry and bitter means over-extracted. Some brewers estimate EY by cross-referencing their coffee-to-water ratio against known TDS ranges for their brew method, but the result is approximate. A precise calculation requires a refractometer reading."
  - q: "What does under-extracted coffee taste like?"
    a: "Under-extracted coffee tastes sour, sharp, and sometimes salty, with little sweetness and a quick, unsatisfying finish. This happens when too little of the bean's soluble material has dissolved -- acids are pulled first, but sugars and other balancing compounds haven't had time to follow."
  - q: "What does over-extracted coffee taste like?"
    a: "Over-extracted coffee tastes bitter, dry, or hollow -- sometimes described as woody or harsh. These unpleasant compounds are the last things water pulls from the grounds, so they only appear when brewing goes too long, the grind is too fine, or water is too hot."
  - q: "Does roast level affect extraction yield?"
    a: "Yes. Darker roasts are more porous and soluble, so they extract faster and more completely at a given grind size and temperature. Lighter roasts are denser and require a finer grind, higher water temperature, or longer contact time to reach the same extraction percentage."
published: true
---
...
## What exactly is coffee extraction yield -- and why should I care?
...
## How do I calculate extraction yield at home?
...
## What does under-extracted coffee actually taste like?
...
## What does over-extracted coffee taste like -- and how do I fix it?
...
## Does roast level change how I should think about extraction?
...
With this in mind, you might do shorter extractions with a finer grind for a dark roast and longer extractions with a medium-coarse grind for a lighter roast. If you're brewing a light Ethiopian natural that tastes persistently sour despite a "correct" recipe, the bean's density -- not your technique -- may be the bottleneck. Try grinding two steps finer before changing anything else. (For a deeper look at how roast levels affect solubility and flavor, see our [coffee roast levels guide](https://percolateapp.com/articles/coffee-roast-levels-explained).)

## Is TDS alone enough to tell me if my coffee is good?
...
## A practical extraction troubleshooting checklist
...
For context on how grind size interacts with all of this, see our [coffee grind size guide](https://percolateapp.com/articles/coffee-grind-size-by-brew-method). And if your brew water's mineral TDS is outside the SCA's 75-250 ppm window, even a perfect extraction yield won't produce a great cup -- our [brew water temperature guide](https://percolateapp.com/articles/brew-water-temperature-guide) covers the water chemistry angle in detail.
